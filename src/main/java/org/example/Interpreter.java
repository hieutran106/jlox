...
import org.example.functions.Clock;
...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    // We will add native function in global scope
    ...
    public Object visitGetExpr(Expr.Get expr) {
        ...
        if (object instanceof LoxInstance) {
            LoxInstance objectInstance = (LoxInstance) object;
    ...
    /**
     * False, nill and empty string are falsy
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        // evaluate superclass if exist, it must be a LoxClass
    ...
    public Void visitIfStmt(Stmt.If stmt) {
        Object ifValue = evaluate(stmt.condition);
        if (isTruthy(ifValue)) {
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        ...
        if (stmt.initializer != null) {
            // evaluate if variable decralation statements have init expression
